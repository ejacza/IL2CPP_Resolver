...
namespace Unity
{
    ...
    public:
        ...
        {
            if (!m_ObjectFunctions.m_Destroy) return;
        ...
        {
            if (!m_ObjectFunctions.m_GetName) return nullptr;
    ...
    namespace Object
    {
        ...
        {
            if (!IL2CPP::Functions.m_pObjectNew) return nullptr;
        ...
        {
            if (!m_ObjectFunctions.m_FindObjectsOfType) return nullptr;
