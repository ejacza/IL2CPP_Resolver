...
namespace Unity
{
    ...
    public:
        ...
        {
            if (!m_GameObjectFunctions.m_AddComponent) return;
        ...
        {
            if (!m_GameObjectFunctions.m_GetComponent) return nullptr;
        ...
        {
            if (!m_GameObjectFunctions.m_GetComponentInChildren) return nullptr;
        ...
        {
            if (!m_GameObjectFunctions.m_GetComponents) return nullptr;
        ...
        {
            if (!m_GameObjectFunctions.m_SetActive) return;
        ...
        {
            if (!m_GameObjectFunctions.m_SetLayer) return;
    ...
    namespace GameObject
    {
        ...
        {
            if (!m_GameObjectFunctions.m_CreatePrimitive) return nullptr;
        ...
        {
            if (!m_GameObjectFunctions.m_Find) return nullptr;
        ...
        {
            if (!m_GameObjectFunctions.m_FindGameObjectsWithTag) return nullptr;
